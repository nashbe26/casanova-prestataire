  ...
  useEffect(() => {
    ...
    const fetchUser = async ()=>{
      try{
        ...
        setDate( new Date(response.user.date).toLocaleDateString("en", {
          day: "2-digit",
          month: "2-digit",
          year: "numeric",
        }))
          ...
          <div className="flex flex-col gap-[33px] items-center justify-start w-full">
            ...
            <div className="flex flex-col font-montserrat items-center justify-start w-full">
              <Img
                ...
                alt="rectangle273"
              />
              <div className="flex sm:flex-col flex-row sm:gap-5 relative left-[-11%] items-center justify-start max-w-[1242px] mt-12 mx-auto md:px-5 w-full">
                <Text
              ...
              <div className="flex md:flex-col flex-row gap-5 relative left-[-11%] items-start justify-start max-w-[1241px] mt-7 mx-auto md:px-5 w-full">
                    ...
                    <div className="flex flex-col font-montserrat items-center justify-start w-[98%] md:w-full">
                      ...
                      <div className="h-[244px] md:h-[248px] mt-1 relative w-[125%]">
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          ...
                          value={dayjs(date)}
                            onChange={(e) => {
                              const dateObject = new Date(e.$d).toISOString();
                              setDate(dateObject);
                              console.log(dateObject);
                            }}
                          />
                  ...
                  <div className="flex flex-col font-montserrat gap-5 items-start justify-start w-full">
                    ...
                    {categories?.map((category, index) => (
                      ...
                      >
                        ...
                        {selectedCategory === category._id && subcategories && (
                          <div className="pl-5">
                            {subcategories.map(
                              (subcategory, subIndex) =>
                                subcategory.categorieId ===
                                  selectedCategory && (
                                  <div
                                  onClick={(e)=>setSelectedSubcategory(subcategory._id)}
                                    key={subIndex}
