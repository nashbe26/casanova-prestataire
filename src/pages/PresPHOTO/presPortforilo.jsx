...
const PresPortfolio = ({ user }) => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-start mt-3.5 w-[67%] md:w-full">
        <div className="flex md:flex-col pl-[2%] flex-row md:gap-5 items-center justify-start w-full">
          <Text
